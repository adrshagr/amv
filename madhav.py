...
##icon
image_icon = PhotoImage(file="C:/project2.0/Images/logo.png")
root.iconphoto(False,image_icon)

Round_box = PhotoImage(file="C:/project2.0/Images/Rounded Rectangle 2.png")
...
#Search Box
Search_image = PhotoImage(file="C:/project2.0/Images/Rounded Rectangle 3.png")
myimage = Label(image = Search_image, bg="#57adff")
myimage.place(x=270,y=120)

weat_image = PhotoImage(file="C:/project2.0/Images/Layer 7.png")
...
Search_icon = PhotoImage(file="C:/project2.0/Images/Layer 6.png")
...
#bottom boxes
firstbox = PhotoImage(file="C:/project2.0/Images/Rounded Rectangle 2.png")
secondbox = PhotoImage(file="C:/project2.0/Images/Rounded Rectangle 2 copy.png")
